...
class DomainSearch extends ContentEntityBase implements DomainSearchInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Domain search entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Domain search entity.'))
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
      ])
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Domain search is published.'))
      ->setDisplayOptions('form', [
